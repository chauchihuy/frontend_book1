...
export class LoginComponent implements OnInit {
  ...
  // /Các thuộc tính để xử lý đầu vào form và trạng thá i.
  phoneNumber: string = '0367229859';
  password: string = '270504';
  ...
  login() {
    ...
    this.userService.login(loginDTO).subscribe({
      ...
      error: (error: any) => {
        this.message = error.message || 'Đăng nhập không thành công. Vui lòng kiểm tra thông tin của bạn.';
      }
  ...
  //         this.message = error.message || 'Đăng nhập không thành công. Vui lòng thử lại.';
  //         return throwError
  //         (() => new Error(error));
  //       })
  //     ).subscribe({
