...
export class EbookService {
  ...
  getDetailEbookCategory(ebookId: number): Observable<Ebook> {
    return this.http.get<Ebook>(`${this.apiBaseUrl}/ebooks/ebookcategories/${ebookId}`);
  }
...
getEbookCategories(ebookId: number): Observable<Ebook> {
  return this.http.get<Ebook>(`${this.apiBaseUrl}/ebooks/ebookcategories/${ebookId}`);
}
